...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(20, 370, 801, 321))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(300, 90, 111, 31))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(320, 0, 101, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(840, 150, 75, 31))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 70, 801, 271))
        ...
        self.pushButton.setGeometry(QtCore.QRect(840, 100, 75, 31))
        ...
        self.pushButton_3.clicked.connect(self.search_doctor)
        self.pushButton_6.clicked.connect(self.add_doctor)
        self.retranslateUi()
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("MainWindow", "Doctor Manage"))
        self.groupBox.setTitle(_translate("MainWindow", "Search Doctor"))
        self.label_2.setText(_translate("MainWindow", "Name:"))
        self.pushButton_3.setText(_translate("MainWindow", "Search Doctor"))
    ...
    def init_data(self,results):
        for i in range(0, len(results)):
            ...
            #self.tableWidget.setItem(i, 6, QtWidgets.QTableWidgetItem(str(results[i][6])))
    ...
    def search_doctor(self):
        ...
        result = data.search_by_name(self.cursor, 'doctor',name_input)
    ...
    def add_doctor(self):
        ...
        labels = ('name', 'phone', 'email', 'address', 'hospital_id')
        values = (name, phone, email, address, hospital)
        if insert_table(self.cnx, 'doctor', labels, values):
            result = get_last_n_rows(self.cnx.cursor(), 'doctor', 1)
            if result:
                self.init_data(result)
    ...
    def export_button_click(self):
        try:
            records = get_all_records(self.cnx.cursor(), 'doctor')
            attributes = ('id', 'name', 'phone', 'email', 'address', 'hospital_id')
            save_to_file('doctor', records, attributes)
            return True
        except:
            return False
